...
const updateVideo = asyncHandler(async (req, res) => {
    ...
    if(thumbnailLocalPath){
        ...
        const deletePrevThumbnail = await deleteFromCloudinary(video.thumbnail,{resourse_type: 'image'});
        
        if(!deletePrevThumbnail) {
            throw new ApiError(400, "Failed to delete previous thumbnail from cloudinary");
        }
